...
[GitHub](https://github.com/rryanlee/regexcite) with:

``` r
# install.packages("devtools")
devtools::install_github("https://github.com/rryanlee/regexcite")
```
...
Another functionality this package contains is `my_add()` which can add
two integers together eg. `my_add(1,2)`. The second argument is optional
and the default value is 10. Here are some additional examples of
my_add() use cases.
...
my_add("no", "strings")
#> [1] Error in my_add("no", "strings"): one of your inputs contains a string value.
```
