...
You can install the development version of regexcite from [GitHub](https://github.com/rryanlee/regexcite) with:
...
```
Another functionality this package contains is `my_add()` which can add two integers together eg. `my_add(1,2)`. The second argument is optional and the default value is 10. Here are some additional examples of my_add() use cases.
```r
library(regexcite)
my_add(0,1)
#> [1] 1
